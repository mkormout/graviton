...
- ✅ **v2.0 Enemy AI** — Phases 4-9 (shipped 2026-04-13)
...
- [x] **Phase 4: EnemyShip Infrastructure** — Base class with state machine, detection, fire loop, dying guard, and steering helpers
- [x] **Phase 5: Beeliner + WaveManager** — First enemy type proves the full spawn-detect-fight-die-loot-wave-complete pipeline
- [x] **Phase 6: Sniper** — Range-holding enemy with flee behavior and slow heavy projectile
- [x] **Phase 7: Flanker** — Orbit-steering enemy with LURKING state and attack burst
- [x] **Phase 8: Swarmer** — Cluster-spawned fragile enemy with proximity cohesion
- [x] **Phase 9: Suicider** — Contact-detonating enemy triggering the existing Explosion component
...
**Plans**: 2 plans
Plans:
- [x] 09-01-PLAN.md — Suicider script (suicider.gd) + explosion.gd hit_ships patch + suicider-explosion.tscn
- [x] 09-02-PLAN.md — Suicider scene (suicider.tscn) + world.gd WaveManager integration + playtest
